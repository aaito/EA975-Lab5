 ...
 * <ul>
 *   <li>{@link Model.impl.AddressImpl#getStreet <em>Street</em>}</li>
 *   <li>{@link Model.impl.AddressImpl#getDistrict <em>District</em>}</li>
 *   <li>{@link Model.impl.AddressImpl#getNumber <em>Number</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddressImpl extends MinimalEObjectImpl.Container implements Address {
	...
	public void setDistrict(String newDistrict) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ADDRESS__DISTRICT, oldDistrict, district));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.ADDRESS__STREET:
				return getStreet();
			case ModelPackage.ADDRESS__DISTRICT:
				return getDistrict();
