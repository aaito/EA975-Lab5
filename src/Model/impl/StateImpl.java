 ...
 *   <li>{@link Model.impl.StateImpl#getPopulation <em>Population</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateImpl extends MinimalEObjectImpl.Container implements State {
	...
	public void setPopulation(long newPopulation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.STATE__POPULATION, oldPopulation, population));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.STATE__NAME:
				return getName();
			case ModelPackage.STATE__POPULATION:
